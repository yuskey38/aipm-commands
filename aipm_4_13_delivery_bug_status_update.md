  ...
  steps:
    ...
    - name: "notify_completion"
      ...
      message: |
        ...
        📝 次のステップ:
        - `/aipm/aipm_4_14_delivery_bug_report_generate` でサマリー確認
...
- verifiedステータスの場合: `/aipm/aipm_4_15_delivery_release_decision`
- `/aipm/aipm_4_14_delivery_bug_report_generate` で全体状況確認
